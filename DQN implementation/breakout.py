...
# INFO_GRAPH_WEIGHTS_DIR='./records3/'
...
# 		if sys.argv[-1] == 'y' and os.path.isfile(INFO_GRAPH_WEIGHTS_DIR+'weights6.h5'):
# 			print('loading weights')
# 			Q.load_weights(INFO_GRAPH_WEIGHTS_DIR + 'weights6.h5')
# 			epsgrdy.epsilon = 0.5858
...
# 				if done: print("done-nal a reward: ", str(reward))
...
# 				if epsgrdy.t >= INITIAL_REPLAY_SIZE and t%10 == 0:
# 					# Train network
...
# 				t = t + 1
# 			if epoch % 20 == 0:
# 				Q.save_weights(INFO_GRAPH_WEIGHTS_DIR + 'weights' + str(int(epoch/20)) + '.h5')
# 			if epoch % 100 == 0:
